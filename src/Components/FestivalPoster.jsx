	...
	return (
		<div className=" p-3">
			...
			<div className="md:flex flex-row content-center align-center w-full">
				<img src={poster} alt="festival poster" className=" w-full md:w-1/2 md:h-auto  p-10 rounded-lg" />
				<div className="p-10">
