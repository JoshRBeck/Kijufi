...
function Platzhalter() {
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-center h-60vh">
      ...
      <h3 className="text-[#323A64] font-bold text-[16px] md:text-[50px] w-3/5 text-center px-20 pb-10 z-10 relative">
        Terminübersicht
      ...
      <a
        ...
        className="btn bg-[#E16848] text-white text-[16px] md:text-[25px] font-bold py-2 px-4 rounded-full mt-10 mb-32 md:hidden z-10 relative"
