...
function FestivalRahmen() {
	return (
		<div className=" bg-[#EFF6F4] m-[15px] p-[15px] rounded-[20px] md:w-[1050px] md:p-[20px] md:m-auto">
			<h2 className="text-shadow-rahmen text-center">RAHMENPROGRAMM & MEHR</h2>

			<p className="mt-[30px] text-[14px] text-[#333C3A] leading-[14px] md:text-[25px] md:leading-[31px] ">
