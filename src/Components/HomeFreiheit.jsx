...
function HomeFreiheit() {
	return (
		<section style={{ backgroundImage: `url(${bg2})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'top' }} className="flex items-center justify-center pl-5 py-10 md:py-0 md:pl-0 md:gap-10  md:h-[500px]  md:m-auto">
