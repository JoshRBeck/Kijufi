...
function TeilFestival() {
	return (
		<div className="m-[15px]">
			...
			<p className="text-[12px] md:text-[25px] ">Das Filmfestival wird maßgeblich von Kindern und Jugendlichen veranstaltet. Die junge Festival-Crew trifft alle wichtigen Entscheidungen – vom Titel und Thema des Festivals über die Filmauswahl bis hin zum Rahmenprogramm. Sie sind es auch, die das Festival hosten: als Filmvorführer:innen, Moderator:innen, Presse-Sprecher:innen und Gäste-Betreuer:innen.</p>
			<p className="text-[12px] md:text-[25px] ">Die Festivalplanung findet im Rahmen offener Projekttage statt. Wir freuen uns über alle, die Lust haben, Teil des Teams zu werden. Ein Einstieg ist bis zum Termin am 11.11.2023 problemlos möglich. Du willst mitmachen? Melde Dich bei uns und komm‘ vorbei!</p>
			<p className="text-[14px] font-semibold pt-3 md:text-[20px] ">
